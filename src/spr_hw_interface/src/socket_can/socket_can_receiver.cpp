...
SocketCanReceiver::SocketCanReceiver(const std::string& interface, const bool enable_fd)
  : m_file_descriptor{ bind_can_socket(interface, enable_fd) }, m_enable_fd(enable_fd)
{
}
...
////////////////////////////////////////////////////////////////////////////////
SocketCanReceiver::CanFilterList::CanFilterList(const char* str) { *this = ParseFilters(str); }
...
////////////////////////////////////////////////////////////////////////////////
SocketCanReceiver::CanFilterList
SocketCanReceiver::CanFilterList::ParseFilters(const std::string& str)
{
